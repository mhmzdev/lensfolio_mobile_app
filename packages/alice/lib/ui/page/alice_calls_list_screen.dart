...
class _AliceCallsListScreenState extends State<AliceCallsListScreen>
    ...
    return Directionality(
      ...
      child: Theme(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            controller: _tabController,
            children: [_buildCallsListWrapper(), _buildLogsWidget()],
          ),
  ...
  List<Widget> _buildActionWidgets(bool isLoggerTab) {
    return isLoggerTab
        ? [_buildLogsChangeButton(), _buildLogsClearButton()]
        : [_buildSearchButton(), _buildMenuButton()];
  }
      ...
      itemBuilder: (BuildContext context) {
        return _menuItems.map((AliceMenuItem item) {
          return PopupMenuItem<AliceMenuItem>(
            ...
            child: Row(
              children: [
                Icon(item.iconData, color: AliceConstants.lightRed),
                ...
                return Wrap(
                  children: [
                    ...AliceSortOption.values
                        .map(
                          (AliceSortOption sortOption) => RadioGroup(
                            onChanged: (value) {
                              setState(() {
                                _sortOption = value;
                              });
                            ...
                            child: RadioListTile<AliceSortOption>(
